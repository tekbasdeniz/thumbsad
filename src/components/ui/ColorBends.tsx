...
export default function ColorBends({
  ...
  useEffect(() => {
    ...
    const clearColorHex = color ? new THREE.Color(color).getHex() : 0x000000;
    renderer.setClearColor(clearColorHex, transparent ? 0 : 1);
  ...
  }, [bandWidth, color, frequency, intensity, iterations, mouseInfluence, noise, parallax, scale, speed, transparent, warpStrength]);
